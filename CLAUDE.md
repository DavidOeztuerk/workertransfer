...
**Verified state (2026-08-02).** Phases 1, 2 and 2.5 are complete; **Phase 3 sub-steps 3.1 (Consent-Ledger), 3.1b (Onboarding) and 3.2 (Profile-Service) are done**. Next up is 3.3 (Resume-Service).
