...
namespace WorkerTransfer.Resume.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912090237_Unterlagenfunde")]
    partial class Unterlagenfunde
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkerTransfer.Resume.Infrastructure.Persistence.FundZeile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SubjectId", "DocumentId")
                        .IsUnique()
                        .HasDatabaseName("uq_terms_subject_document");

                    b.ToTable("resume_document_terms", (string)null);
                });
