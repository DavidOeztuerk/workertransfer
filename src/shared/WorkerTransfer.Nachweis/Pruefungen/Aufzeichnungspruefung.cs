...
/// </remarks>
/// <param name="gegenstandVorhanden">
/// Ob es hier überhaupt etwas aufzuzeichnen gibt: der Dienst fragt ein Modell
/// <em>oder</em> er hält die Einstellung, die eine Aufzeichnung verspricht.
/// Das Zweite ist identity-service, und ohne diesen Fall fiele der interessante
/// Befund weg — ein Schalter, den niemand liest, wäre dort „nicht anwendbar“.
/// </param>
/// <param name="aufzeichnung">Wer Auskunft geben kann, oder <c>null</c>.</param>
/// <param name="schalterVorhanden">
/// Ob die Oberfläche einen Schalter „Anfragen protokollieren“ zeigt.
/// </param>
public sealed class Aufzeichnungspruefung(
    bool gegenstandVorhanden,
