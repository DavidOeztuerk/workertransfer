...
public static class LoeschEndpoints
{
    ...
    public static IEndpointRouteBuilder MapLoeschEndpoints(this IEndpointRouteBuilder app)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            // Eine Zahl, kein Merker: in der Voreinstellung ist sie 0, weil auch
            // die eingestellte Bewerbung fällt. Bliebe je etwas stehen, soll der
            // Ursprung es erfahren, statt es zu vermuten — ausgesetzt ist nicht
            // übersprungen (ADR-0027 §3.4).
