...
/// dasselbe Papier sein (ADR-0027 §4.4). Leer heißt zu — bei einem Endpunkt,
/// der alles über einen Menschen löscht, wäre eine Voreinstellung, die im
/// Zweifel öffnet, die denkbar schlechteste.
/// </remarks>
