"""Applications Service configuration.
...
class ApplicationsServiceSettings(PlatformSettings):
    service_name: str = "applications-service"
    port: int = 8000

    database_url: str = "postgresql+asyncpg://worker:worker@127.0.0.1:5432/applications"
