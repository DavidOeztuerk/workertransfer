 ...
 *
 * NOCH NICHT migriert: `/careers/<slug>`, `/jobs/:id/apply`, `/applications`,
 * `/market`, `/transfers`. Sie stehen in
 ...
 */
export const workRoutes: RouteObject[] = [{ path: "/jobs", element: <JobsPage /> }];
