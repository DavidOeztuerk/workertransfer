"""Composition-Root der Jobs-Service-App (ADR-0003)."""
...
def build_app(settings: JobsServiceSettings) -> FastAPI:
    ...
    return create_api_app(
        ...
        # Die Auth-Middleware macht aus einem fehlenden Token bewusst keinen
        # 401 — die öffentliche Suche braucht das.
