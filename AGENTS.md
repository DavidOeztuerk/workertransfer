...
- **Problem documents stay English on the wire** and describe a shape; the UI translates by status. Twelve services with twelve copies of one catalogue is the divergence everything else here defends against.
