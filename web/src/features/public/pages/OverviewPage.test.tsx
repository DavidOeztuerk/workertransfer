...
const ANGEMELDET = {
  ...
  session: { userId: SUBJECT, email: "anna@example.com", tenantId: null, language: "de", displayName: "Anna Beispiel", givenName: "", familyName: "" },
};
...
const MIT_FIRMA = {
  ...
  session: {
    ...
    tenantId: TENANT,
    language: "de", displayName: "Anna Beispiel", givenName: "", familyName: "",
  },
};
