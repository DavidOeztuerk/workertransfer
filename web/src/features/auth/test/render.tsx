 ...
 * Durchgang darf `shared/` nicht anfassen. Sie ist das wörtliche Gegenstück zu
 * `features/public/test/render.tsx`; wer die Bereiche später zusammenzieht,
 * legt eine davon nach `shared/test/` und wirft beide hier weg.
 *
