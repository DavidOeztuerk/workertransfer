...
export function DeleteAccountPage() {
  ...
  if (status !== "authenticated") {
    return <AnmeldungNoetig titel="Konto löschen" zweck="dein Konto zu löschen" />;
  }
  ...
  return (
    ...
    >
      ...
      <Abschnitt titel="Was bleibt — und warum">
        <Typography variant="body2" color="text.secondary">
          Ein Nachweis darüber, <em>dass</em> gelöscht wurde: welche Freigaben unter deiner Kennung
          einmal erteilt und wann sie zurückgenommen wurden. Ohne ihn ließe sich nicht mehr
          belegen, dass wir deiner Löschung nachgekommen sind. Was du selbst hineingeschrieben hast
          — etwa der Grund für eine zurückgenommene Freigabe — wird dabei entfernt. Übrig bleiben
          Kennungen und Zeitpunkte, die auf keinen Menschen mehr zeigen.
        </Typography>
      </Abschnitt>
              ...
              <Typography component="li" key={firma.id} sx={{ mb: 0.5 }}>
                ...
                {firma.role === "admin" ? (
                  <>
                    ...
                    zurückgezogen. Eine Anzeige, hinter der niemand mehr steht, ist schlechter als
                    keine: Bewerbungen liefen an niemanden.
                  </>
                ) : (
      ...
      <Abschnitt titel="Wie es abläuft">
        <Typography variant="body2" color="text.secondary" sx={{ mb: 1.5 }}>
          ...
          widerrufen. Die Löschung selbst läuft danach weiter — sie geht <strong>nicht sofort</strong>{" "}
          durch, weil deine Daten bei mehreren Diensten liegen und jeder einzeln bestätigen muss. Du
      ...
      <Card>
        <CardContent>
          ...
          {fragt ? (
            ...
            <Button variant="outlined" color="error" onClick={() => setFragt(true)}>
              Konto löschen
            </Button>
          )}
        </CardContent>
